...
df_drivers = df_drivers.select('code','dateOfBirth','driverId','familyName','givenName','nationality','permanentNumber','url','year','date_load_bronze','SkDrivers')
...
if spark.catalog.tableExists("f1_bronze.drivers"):
    ...
    print("upsert")
    upsert(df_target,"Skdrivers",df_drivers,"Skdrivers")
else:
    print("New")
